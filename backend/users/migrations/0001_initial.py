    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Укажите username', max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Пользователь с username существует', regex='^[\\w.@+-]+$')], verbose_name='username')),
